...
const countries = [
  ...
  { text: "Vytvořte si účet Amare Brand Partner z České Republiky", link: "/create-an-amare-brand-partner-account-from/czech_republic" },
  ...
  { text: "Create an Amare Brand Partner Account from New Zealand", link: "/create-an-amare-brand-partner-account-from/new_zealand" },
  ...
  { text: "Create an Amare Brand Partner Account from the United States", link: "/create-an-amare-brand-partner-account-from/united_states" },
