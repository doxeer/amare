...
const products = [
  ...
  },
  {
    ...
    description: "Comprehensive Gut-Brain Axis Nutrition Trio Pack Raspberry Hibiscus",
    price: "$146.95",
  ...
  },
  {
    ...
    description: "Plant-Based Nootropic Drink For Motivation and Healthy Memory Variety Pack",
    price: "$202.95",
  ...
  },
  {
    id: 8,
    name: "MentaBiotics®",
    description: "Advanced Gut-Brain Axis Nutrition Stick Packs with Probiotics and Prebiotics for Mind and Body",
    price: "$73.95",
  ...
  },
  {
    id: 9,
    name: "MentaFocus",
    description: "Phytonutrients for the Brain to Optimize Cognition, Mental Sharpness, Focus, and Clarity",
    price: "$45.95",
    imageUrl: MentaFocus,
    alt:"MentaFocus",
  ...
  },
  {
    id: 12,
    name: "MentaSync®",
    description: "Prime your immune system to optimize the communication sync of chemical messengers between your brain and your gut with the clinically studied key ingredients in MentaSync.*",
    price: "$55.95",
    imageUrl: MentaSync ,
    alt:"MentaSync",
  ...
  },
  {
    id: 13,
    name: "MentaHeart™",
    description: "The first product of its kind to support mental wellness through the heart-brain axis, MentaHeart features key ingredients backed by multiple clinical studies shown to help optimize the heart, the body’s third brain.*",
    price: "$78.95",
    imageUrl: MentaHeart,
    alt:"MentaHeart",
  ...
  },
  {
    id: 14,
    name: "Mood+",
    description: "The key ingredients in Mood+ have multiple scientific studies that show significant benefits for mood support such as relief from anxious feelings, sadness, restlessness, and overall stress relief.*",
    price: " $60.95",
    imageUrl: moodplus,
    alt:"moodplus",
  ...
  },
  {
    id: 15,
    name: "GBX SuperFood",
    description: "GBX SuperFood™ provides the phytonutrient equivalent of three servings of fruits and vegetables per scoop. This phytobiotic-rich blend delivers cellular level anti-stress benefits and helps protect cells from a variety of different stressors, helping the brain and gut run at peak efficiency.*",
    price: "$30.95",
  ...
  },
  {
    id: 16,
    name: "Kids Mood+™",
    description: "Multiple scientific studies have shown the key ingredients in Kids Mood+ provide significant benefits for mood support, including stress resilience, cognitive performance, calmness, focus, and positivity. All in a delicious, easy to digest powder — perfect for kids and teens.*",
    price: "$45.95",
  ...
  },
  {
    id: 17,
    name: "Amare GBX FIT™",
    description: "The world's first QUADbiotic formula in a convenient & cool purple pill that targets the gut microbiome for healthy weight loss.",
    price: "$69.95 ",
    imageUrl: Gbxfit,
    alt:"Amare GBX FIT™",
  ...
  },
  {
    id: 18,
    name: "Sleep+",
    description: "The key ingredients in Sleep+ have multiple scientific studies that show significant benefits including helping you to fall asleep faster, stay asleep longer, and experience higher quality plus more rejuvenating sleep.*",
    price: "$60.95",
    imageUrl: sleepplus,
    alt:"sleepplus",
  ...
  },
  {
    id: 19,
    name: "OmMega®",
    description: "OmMega is a sustainably sourced, lavender-infused fish oil that features a 5:1 ratio of EPA to DHA scientifically shown to support mental wellness.*",
    price: "$31.95",
    imageUrl: ommega,
    alt:"ommega",
  ...
  },
  {
    ...
    imageUrl: ommega,
    alt:"",
    buyLink: "https://www.amare.com/1942935/en-us/"
  },
